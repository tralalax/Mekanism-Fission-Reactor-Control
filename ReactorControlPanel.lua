...
ReactorPort = "fissionReactorLogicAdapter_0"
BoilerPort = "boilerValve_0"
MatrixPort = "inductionPort_0"
Monitor1Port = "monitor_0"
Monitor2Port = "monitor_1"
Monitor3Port = "monitor_2"
